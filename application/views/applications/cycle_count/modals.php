    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="delete_loc_form" action="<?= site_url('cycle_count/delete_locations'); ?>" method="POST">
          <label>Please provide the reason for deleting the locations.</label>
      ...
      <div class="modal-footer">
        ...
        <button id="delete_loc" type="button" class="btn btn-sm btn-danger" data-dismiss="modal">YES</button>
      </div>
    </div>
  </div>
</div>