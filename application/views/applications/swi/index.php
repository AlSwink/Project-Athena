...
<div class="container-fluid d-print-none">
		...
		<div class="col col-sm-12">
			<ul class="nav nav-tabs nav-fill dashboard_tabs">
				...
				<li class="nav-item">
			  	...
			  	<li class="nav-item">
			    	<a class="nav-link" data-toggle="tab" href="#swi_logs"><i class="fas fa-table"></i> Logs</a>
			  	</li>
			  	<!--li class="nav-item">
			  	...
			  	<li class="nav-item">
			    	<a class="nav-link" data-toggle="tab" href="#swi_changelog"><i class="fas fa-file-code"></i> Changelog</a>
			  	</li>
			</ul>
		</div>
	</div>
	<div class="row">
		<div class="tab-content col">
			...
			<div class="tab-pane " id="swi_changelog" role="tabpanel">
