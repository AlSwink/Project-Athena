<div class="row mt-3">
	<div class="col-3">
		...
		<div class="input-group mb-3">
		  <input type="text" id="assignment_id" class="form-control alpha-no" placeholder="eg. AI-001">
		...
		<div class="list-group shadow mt-3">
		  <a href="#" class="list-group-item list-group-item-action list-group-item-primary"><i class="fas fa-print"></i> Re-print Sheet</a>
	...
	<div class="col">
		<div class="card shadow">
			<div class="card-body p-3" style="min-height: 80%">
				...
				<form id="swi_worksheet_form" action="<?= site_url('swi/save_swi_worksheet'); ?>" method="POST">
					<div id="swi_input_table" class="table-responsive">
